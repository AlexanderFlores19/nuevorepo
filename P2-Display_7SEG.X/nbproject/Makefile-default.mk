...
SOURCEFILES_QUOTED_IF_SPACED=P2_Display_7seg.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/P2_Display_7seg.o
POSSIBLE_DEPFILES=${OBJECTDIR}/P2_Display_7seg.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/P2_Display_7seg.o

# Source Files
SOURCEFILES=P2_Display_7seg.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/P2_Display_7seg.o: P2_Display_7seg.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/P2_Display_7seg.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/P2_Display_7seg.o \
	P2_Display_7seg.s \
